...
from PizzeriaManager.views import (ConfirmBookingView, ConfirmLeave,
                                   ContactView, CreateBookingView,
                                   CreatePizzaView, DeleteBookingView,
                                   DeleteLeaveView, DeleteOrderView,
                                   DeletePizzaView, DeleteShiftView,
                                   DeleteUserView, ListAllBookings,
                                   ListAllLeaves, ListLeaves, ListOrdersView,
                                   ListOrderView, ListUserBookings,
                                   RequestLeave, ShiftCreateView,
                                   ToppingCreateView, ToppingDeleteView,
                                   UpdateBookingView, UpdateLeaveView,
                                   UpdateOrderView, UpdateShiftView,
                                   UpdateToppingView, UpdateUserDetails,
                                   UpdateUserView, UpdatPizzaDetails,
                                   ViewUsersView, cart_add, cart_clear,
...
urlpatterns = [
    ...
    path(
        "order_update/<int:pk>", UpdateOrderView.as_view(), name="update_orders_manager"
    ),
    path(
        "order_delete/<int:pk>", DeleteOrderView.as_view(), name="delete_orders_manager"
    ),
    path("view_staff", view_staff, name="view_staff"),
    path("create_shift", ShiftCreateView.as_view(), name="create_shift"),
    path(
        "shift_update/<int:pk>", UpdateShiftView.as_view(), name="update_shift_manager"
    ),
    path(
        "shift_delete/<int:pk>", DeleteShiftView.as_view(), name="delete_shift_manager"
    ),
    ...
    path(
        "user_detail_update/<int:pk>",
        UpdateUserDetails.as_view(),
        name="update_details",
    ),
    path("create_Ingredient", ToppingCreateView.as_view(), name="create_topping"),
    path(
        "delete_Ingredient/<int:pk>", ToppingDeleteView.as_view(), name="delete_topping"
    ),
    path(
        "update_Ingredient/<int:pk>", UpdateToppingView.as_view(), name="update_topping"
    ),
    path("list_pizzas_for_edit", listPizzas, name="list_pizzas"),
    path("delete_pizza/<int:pk>", DeletePizzaView.as_view(), name="delete_pizza"),
    path(
        "pizza_detail_update/<int:pk>",
        UpdatPizzaDetails.as_view(),
        name="update_pizza_details",
    ),
