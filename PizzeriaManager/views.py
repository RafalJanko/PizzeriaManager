...
def index(request):
    if request.method == "GET":
        ...
        return render(
            request,
            "PizzeriaManager/menu.html",
            {"pizzas": pizzas, "number": number, "number_items": number_items},
        )
...
def cart_detail(request):
    ...
    return render(
        request,
        "PizzeriaManager/cart.html",
        {"number": number, "number_items": number_items},
    )
...
def checkout(request):
    if request.method == "POST":
        ...
        return render(
            request,
            "PizzeriaManager/checkout.html",
            {"number": number, "number_items": number_items, "total": total},
        )
...
def ListOrderView(request):
    ...
    return render(
        request,
        "PizzeriaManager/orderlist.html",
        {
            "number": number,
            "number_items": number_items,
            "total": total,
...
def ConfirmLeave(request):
    if request.method == "POST":
        ...
        leave = DaysOff.objects.create(
            start_date=start_date, end_date=end_date, reason=reason, user_id=user_id
        )
...
def ListLeaves(request):
    if request.method == "GET":
        ...
        return render(
            request, "PizzeriaManager/listuserleaves.html", {"leaves": leaves}
        )
...
def listPizzas(request):
    if request.method == "GET":
        ...
        return render(
            request,
            "PizzeriaManager/list_pizzas_for_edit.html",
            {"pizzas": pizzas, "toppings": toppings},
        )
...
def ListAllBookings(request):
    if request.method == "GET":
        ...
        return render(
            request, "PizzeriaManager/listallbookings.html", {"bookings": bookings}
        )
...
def ConfirmBookingView(request):
    if request.method == "POST":
        ...
        booking = Booking.objects.create(
            ...
            booking_no_of_people=booking_no_of_people,
        )
        ...
        body_email = (
            f"Thank you for sending a request to book a table. "
