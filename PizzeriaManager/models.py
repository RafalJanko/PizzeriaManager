...
class Profile(models.Model):
    ...
    function = models.CharField(
        max_length=10, choices=function_choices, default="Customer"
    )
...
class PizzaMenuItem(models.Model):
    ...
    ingredients = models.ManyToManyField("PizzaIngredient", related_name="ingredients")
...
class OrderItem(models.Model):
    ...
    size = models.CharField(max_length=5, blank=True)
    toppings = models.ManyToManyField(PizzaIngredient, blank=True, related_name="pizza")
